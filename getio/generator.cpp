...
const ll mod=1e9+7; const ll inf=999999999999999999; 
const ll MAXN=1e6; const ld eps=1e-6;
...
g++ -std=c++11 -D DEBUG 2>./getio/error.log filename.cpp -o ./bin/a.o && ./bin/a.o ;exit 
*/
